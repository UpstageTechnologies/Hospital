...
const Appointment = () => {
  ...
  const doctorList = [
    { id: 1, name: "Dr. Richard James", speciality: "General physician", image: "/Doctors/doc1.png" },
    { id: 2, name: "Dr. Emily Larson", speciality: "Gynecologist", image: "/Doctors/doc2.png" },
    { id: 3, name: "Dr. Sarah Patel", speciality: "Dermatologist", image: "/Doctors/doc3.png" },
    { id: 4, name: "Dr. Christopher Lee", speciality: "Pediatricians", image: "/Doctors/doc4.png" }
  ]

  const doctor = doctorList.find(doc => doc.id.toString() === docId)
  ...
  setDocInfo({
    ...
    degree: "MBBS",
    experience: "4 Years",
    about: "Dr has strong commitment to delivering comprehensive medical care.",
    fees: 50
  })
