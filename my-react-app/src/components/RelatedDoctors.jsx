        ...
        <div>
            <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
                ...
                <div className='w-full grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 pt-5 px-3 sm:px-0'>
                    ...
                    <div className='col-span-2 md:col-span-3 lg:col-span-5 flex justify-center mt-10'>
                        <button onClick={() => { navigate('/doctors'); scrollTo(0, 0) }} className='bg-blue-100 px-12 py-3 rounded-full'>more</button>
                    </div>
                </div>
            </div>
        </div>
