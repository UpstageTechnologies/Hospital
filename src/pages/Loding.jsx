    ...
    return (
        <div className="flex flex-col md:flex-row items-center justify-center min-h-screen px-6 md:px-28 lg:px-40 py-10 bg-gradient-to-br from-gray-100 to-gray-200 gap-10">
           <div className="max-w-xl mt-10 md:mt-16 order-1 md:order-1">
               ...
               <div className="bg-white p-6 rounded-2xl shadow-xl border border-gray-200 w-full max-w-[380px] mt-6 mb-10 order-3 md:order-none">
          ...
          <div className="mt-10 md:mt-0 flex justify-center items-center md:ml-10 order-2 md:order-none">
